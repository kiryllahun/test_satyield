# The name of this view in Looker is "Comparison Table per State Brazil Soy"
view: comparison_table_per_state_brazil_soy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `satyield-algo.SatYield_Test_database.Comparison_Table_per_State_Brazil_SOY` ;;

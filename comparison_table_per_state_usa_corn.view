# The name of this view in Looker is "Comparison Table per State Usa Corn"
view: comparison_table_per_state_usa_corn {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `SatYield_Test_database.Comparison Table per State_USA_CORN` ;;
